...
class FavariteProducts: NSObject,NSCoding{
    var id = String()
    var name = String()
    ...
    init(id:String,name:String,product_description:String,row_order:String,other_images:[String],image:String,indicator:String,slug:String,variants:[Variants],price:String,subcategory_id:String,status:String,date_added:String,category_id:String,product_count:String) {
        self.id = id
        self.name = name
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        self.product_count = aDecoder.decodeObject(forKey: "product_count") as! String
    ...
    func encode(with aCoder: NSCoder) {
        ...
        aCoder.encode(self.product_count, forKey: "product_count")
